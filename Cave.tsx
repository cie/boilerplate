...
<tileset version="1.2" tiledversion="1.2.3" name="Cave" tilewidth="32" tileheight="32" tilecount="140" columns="20">
 <image source="data/img/map/area01_level_tiles.png" trans="ff00ff" width="640" height="241"/>
 <terraintypes>
  <terrain name="Föld" tile="3"/>
  <terrain name="Lyuk" tile="67"/>
 </terraintypes>
